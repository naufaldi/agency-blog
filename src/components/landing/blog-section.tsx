...
const blogPosts = [
  {
    ...
    excerpt:
      'Learn how to structure your React applications for maximum maintainability and performance.',
    date: '2026-01-15',
    readTime: '8 min',
  ...
  },
  {
    ...
    excerpt:
      'Explore the latest CSS features and how they can transform your web development workflow.',
    date: '2026-01-10',
    readTime: '6 min',
    tags: ['CSS', 'Design', 'Web'],
  },
  {
    ...
    excerpt:
      'A deep dive into designing APIs that are intuitive, performant, and developer-friendly.',
    date: '2026-01-05',
    readTime: '10 min',
          ...
          >
            ...
            <div className="px-6 py-4 border-t border-slate-700 bg-slate-800/30 flex items-center justify-between">
              <div className="font-mono text-sm text-slate-500">
                <span className="text-green-400">✓</span> {blogPosts.length} posts loaded
