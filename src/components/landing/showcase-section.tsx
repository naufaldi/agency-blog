          ...
          <div className="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {projects.map((project) => (
              <Card
                key={project.id}
                className={`
                  border-slate-700 bg-slate-800/50 overflow-hidden transition-all duration-200
              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="relative h-48 bg-linear-to-br from-slate-700 to-slate-800 overflow-hidden">
                    ...
                    <div
                      className={`
                        absolute inset-0 bg-slate-900/95 p-4 transition-all duration-200 flex flex-col justify-center
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="font-mono font-semibold text-white mb-1">{project.title}</h3>
